...
final getNotesUseCaseProvider = Provider(
  (ref) => GetNoteUseCase(ref.watch(noteProvider)),
);
final addNoteUseCaseProvider = Provider(
  (ref) => AddNoteUseCase(ref.watch(noteProvider)),
);
final updateNoteUseCaseProvider = Provider(
  (ref) => UpdateUseCase(ref.watch(noteProvider)),
);
final deleteNoteUseCaseProvider = Provider(
  (ref) => DeleteNoteUseCase(ref.watch(noteProvider)),
);
final deleteAllUseCaseProvider = Provider(
  (ref) => DeleteAllUseCase(ref.watch(noteProvider)),
);
